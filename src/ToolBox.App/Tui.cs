...
public class Tui
{
	public static void Run_tui(CommandRegistry registry)
	{
		using IApplication app = Application.Create();
		app.Init();

		List<ICommand> commands = [.. registry.All()];
		...
		StatusBar statusBar = new([
			new Shortcut(new Key("esc"), "Quit", () => app.RequestStop()),
			new Shortcut(Key.Enter, "Exec", () => { /* automaticaly generated by view.Accepting */ }),
		]);
